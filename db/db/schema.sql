...
create table if not exists public.banners (
  ...
  image_url_mobile text,            -- optional: separate crop/photo for narrow viewports —
                                     -- falls back to image_url when null (see style.css)
  link_url text,
...
values ('Cold Pressed Coconut Oil', '/assets/hero-coconut-oil.jpg', '/shop', 'homepage_hero', true, 1)
...
values ('New Batch Just Pressed', 'Fresh stock of Virgin Coconut Oil is in — while it lasts.', '/assets/hero-coconut-oil.jpg', '/shop', 'homepage_promo', true, 1)
on conflict do nothing;
